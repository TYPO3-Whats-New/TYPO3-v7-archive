...
\section{Test hoofdstuk}
\begin{frame}[fragile]
	\frametitle{Test hoofdstuk}

	\begin{center}\huge{Test hoofdstuk:}\end{center}
	\begin{center}\huge{\color{typo3darkgrey}\textbf{LaTeX stijlen, Formattering, etc.}}\end{center}
