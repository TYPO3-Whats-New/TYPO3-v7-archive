...
\section{TSconfig \& TypoScript: Procesadores de Datos}
\begin{frame}[fragile]
	\frametitle{TSconfig \& TypoScript: Procesadores de Datos}

	\begin{center}\huge{Capítulo 3:}\end{center}
	\begin{center}\huge{\color{typo3darkgrey}\textbf{TSconfig \& TypoScript: Procesadores de Datos}}\end{center}

\end{frame}

% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		6911d747-177b4168-eccc7e49-0af880cd
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{Introduciendo Procesadores de Datos}
	...
	\begin{itemize}
		...
		\item Se han introducido los siguientes Procesadores de Datos, que permiten un procesamiento flexible
			de listas separadas por comas, vectores, ficheros, etc.:
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		970d4096-eb23b3c7-18f80c90-c163b118
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{SplitProcessor}}
	...
	\begin{itemize}
		...
		\item El "SplitProcessor" permite separar valores separados por un delimitador en un array
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		33171244-d6d2f2bc-9fd71ec7-0863b129
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{CommaSeparatedValueProcessor} (1)}
	...
	\begin{itemize}
		...
		\item El "CommaSeparatedValueProcessor" separa valores separados por un delimitador en un vector bidimensional:
		...
		\item Útil para procesar ficheros CSV por ejemplo o \texttt{tt\_content} data sets de CType "tabla"

			\vspace{0.2cm}
			\small
				Ver un uso de ejemplo en Fluid en la siguiente diapositiva
			\normalsize
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		09779d6b-853f6c04-b185df52-86470258
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{CommaSeparatedValueProcessor} (2)}
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		a2c387c5-50c676bb-cf32a0ed-d5c50c96
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{FilesProcessor} (1)}
	...
	\begin{itemize}
		...
		\item El "FilesProcessor" resuelve referencias de fichero, ficheros, o ficheros dentro de una carpeta o colección
			para ser usados de salida en el frontend
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		7aa99335-35a1b53e-a8e07b77-d3e70e71
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{FilesProcessor} (2)}
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		40cbbfcb-7662b6ce-f1525739-9a05d5e7
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{GalleryProcessor}}
	...
	\begin{itemize}
		...
		\item El "GalleryProcessor" calcula el máximo tamaño asset de conjuntos de ficheros
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		2c2688a8-dd372bf4-8292ec44-1b8c28ce
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{DatabaseQueryProcessor} (1)}
	...
	\begin{itemize}
		...
		\item El "DatabaseQueryProcessor" puede usarse para recoger datos de la base de datos
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		a9a91c1c-e8d10896-1593e25b-ab0aab78
...
\begin{frame}[fragile]
	\frametitle{Procesadores de Datos TypoScript}
	\framesubtitle{El \texttt{DatabaseQueryProcessor} (2)}
